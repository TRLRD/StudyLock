...
# Prevent a deleted Qt overlay from being reused on the next question.
...
if old not in s:
    raise SystemExit('answer block pattern not found')
...
if old not in s:
    raise SystemExit('stop block pattern not found')
s = s.replace(old, new, 1)
...
if old not in s:
    raise SystemExit('trigger block pattern not found')
s = s.replace(old, new, 1)
...
if old not in s:
    raise SystemExit('trigger_question block pattern not found')
s = s.replace(old, new, 1)

# Improve the answer buttons so hover/press feels deliberate and not like a default Qt button.
old = '''                "QPushButton:hover{background:rgba(58,76,119,248);border:1px solid rgba(127,151,255,235);padding-left:22px;} \\\n                "QPushButton:pressed{background:rgba(92,124,255,255);border:1px solid rgba(180,195,255,255);padding-left:25px;}")\n'''
new = '''                "QPushButton:hover{background:rgba(58,76,119,248);border:1px solid rgba(127,151,255,235);padding-left:22px;} \\\n                "QPushButton:pressed{background:rgba(92,124,255,255);border:1px solid rgba(180,195,255,255);padding-left:25px;} \\\n                "QPushButton:focus{border:1px solid rgba(150,170,255,245);}\")\n'''
if old in s:
    s = s.replace(old, new, 1)
